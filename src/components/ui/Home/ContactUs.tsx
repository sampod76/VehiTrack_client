...
export default function ContactUs() {
  return (
    ...
    <div className="container px-6 py-12 mx-auto shadow-2xl">
        <div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Sampodnath8767@gmai.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Noakhali</p>
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">2501 Charbata,Noakhali</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+8801875114417</p>
                </div>
            </div>
