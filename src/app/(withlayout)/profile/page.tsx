      ...
      <div className="">
        {
          ...
          data?.role !== USER_ROLE.SUPER_ADMIN ? (
            <Row gutter={[16, 16]}>
              <Col sm={24} md={12}>
                <div className="max-w-3xl  sm:max-w-sm md:max-w-sm lg:max-w-2xl xl:max-w-2xl sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto  bg-white shadow-xl rounded-lg text-gray-900">
                ...
                /> */}
                  ...
                  <div className="p-1 md:p-4 border-t md:mx-8 mt-2">
                    ...
                    <input
                      ...
                      className="text-black w-full border-2 rounded-md p-3"
                    />
                  </div>
                  <div className="p-1 md:p-4 border-t md:mx-8 mt-2  ">
                    ...
                    <p className="text-black  border-2 rounded-md p-3">
                      ...
                      solid track record in the field. Outstanding safety
                      background and consistently requested by repeat customers
                ...
                than last year <span className="blue">+10%</span>
                  ...
                  <div className="overflow-auto h-[352px] scrollbar-thin scrollbar-track-transparent scrollbar-thumb-blue-200 scrollbar-track-rounded-full scrollbar-thumb-rounded-full pr-1.5">
                    ...
                    <ul className="my-1">
                      {
                        //@ts-ignore
                        allUserData?.userInfo?.trips?.map((data, i) => (
                          <li
                            key={i}
                          ...
                          >
                            ...
                            <div>
                              <h1 className="fle">{data?.tripNo}</h1>
                            </div>
                            <div>
                              Start time :{" "}
